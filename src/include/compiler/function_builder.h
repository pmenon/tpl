...
class FunctionDeclaration {
 public:
  ...
  struct ArgumentInfo {
    std::string name;
    Type *type;
    ArgumentInfo(std::string _name, Type *_type)
  ...
  FunctionDeclaration(CodeContext &cc, const std::string &name,
                      Visibility visibility, Type *ret_type,
...
class FunctionBuilder {
 ...
 public:
  ...
  FunctionVal *GetFunction() const { return func_; }
 ...
 private:
  ...
  Block *GetEntryBlock() const { return entry_bb_; }
