...
class SqlType {
 public:
  SqlType(tpl::type::TypeId type_id) : type_id_(type_id) {}
  virtual ~SqlType() {}

  virtual tpl::type::TypeId TypeId() const { return type_id_; }
  ...
  static const SqlType &LookupType(tpl::type::TypeId type_id);
