...
/**
 * Container for small-ish strings whose lifetime are all the same. Used during execution for
 * intermediate strings, and in string vectors. Actually a thin wrapper around a memory region.
 */
class StringHeap {
 public:
  /**
...
inline StringHeap::StringHeap() : region_("strings"), num_strings_(0) {}
