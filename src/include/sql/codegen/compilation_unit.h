...
class CompilationUnit {
 ...
 public:
   ...
   */
  void RegisterStruct(ast::StructDeclaration *decl) { structs_.push_back(decl); }
   ...
   */
  void RegisterFunction(ast::FunctionDeclaration *decl) { functions_.push_back(decl); }
 ...
 private:
  ...
  llvm::SmallVector<ast::StructDeclaration *, 16> structs_;
  llvm::SmallVector<ast::FunctionDeclaration *, 16> functions_;
};
