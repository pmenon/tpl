...
compiler::Value RowBatch::Row::DeriveValue(
    CodeGen &codegen, const parser::AbstractExpression &expr) {
  // First check cache
  ...
  TPL_ASSERT(translator != nullptr, "null translator for expression");
