...
TEST_F(RiscVsCiscTest, DISABLED_StackVM) {
  S param{.a = 0, .b = 1, .c = 0};
...
TEST_F(RiscVsCiscTest, DISABLED_Risc) {
  S param{.a = 0, .b = 1, .c = 0};
  ...
  // clang-format off
  u8 ops[] = {
      static_cast<u8>(Risc::Op::LoadAddr), 20, 0, 1,  // lea A0, 0(R1)
      static_cast<u8>(Risc::Op::StoreImm), 1, 0, 20,  // si 1, 0(A0)
      static_cast<u8>(Risc::Op::LoadAddr), 21, 0, 1,  // lea A1, 0(R1)
      static_cast<u8>(Risc::Op::StoreImm), 2, 8, 21,  // si 2, 8(A1)
      static_cast<u8>(Risc::Op::StoreImm), 3, 0, 0,   // si 3, 0(R0)
      static_cast<u8>(Risc::Op::StoreImm), 4, 8, 0,   // si 4, 8(R0)
      static_cast<u8>(Risc::Op::LoadInd), 7, 0, 0,    // lw T3, 0(R0)
      static_cast<u8>(Risc::Op::LoadInd), 9, 8, 0,    // lw T5, 8(R0)
      static_cast<u8>(Risc::Op::Add), 10, 7, 9,       // add T6, T3, T5
      static_cast<u8>(Risc::Op::LoadAddr), 22, 0, 1,  // lea A2, 0(R1)
      static_cast<u8>(Risc::Op::LoadInd), 11, 0, 22,  // lw T7, 0(A2)
      static_cast<u8>(Risc::Op::Add), 12, 10, 11,     // add T8, T6, T7
      static_cast<u8>(Risc::Op::LoadAddr), 23, 0, 1,  // lea A3, 0(R1)
      static_cast<u8>(Risc::Op::LoadInd), 13, 8, 23,  // lw T9, 8(A3)
      static_cast<u8>(Risc::Op::Add), 14, 12, 13,     // add T10, T8, T9
      static_cast<u8>(Risc::Op::LoadAddr), 25, 0, 1, // lea A5, 0(R1)
      static_cast<u8>(Risc::Op::Store), 14, 16, 25,    // sw T10, 16(A5)
      static_cast<u8>(Risc::Op::LoadAddr), 24, 0, 1, // lea A4, 0(R1)
      static_cast<u8>(Risc::Op::LoadInd), 15, 16, 24,  // lw T11, 16(A4)
      static_cast<u8>(Risc::Op::LoadInd), 16, 8, 0,   // lw T12, 8(R0)
      static_cast<u8>(Risc::Op::Add), 18, 15, 16,     // add T14, T11, T12
      static_cast<u8>(Risc::Op::Store), 18, 16, 0,    // sw T14, 16(R0)
      static_cast<u8>(Risc::Op::Jump),
  };
  // clang-format on
...
TEST_F(RiscVsCiscTest, DISABLED_Risc2) {
  S param{.a = 0, .b = 1, .c = 0};
...
TEST_F(RiscVsCiscTest, DISABLED_Risc2_With_Ptr_Cache) {
  S param{.a = 0, .b = 1, .c = 0};
  ...
  // clang-format off
  u8 ops[] = {
      static_cast<u8>(Risc2::Op::LoadAddr), 4, 1,       // la L1_ptr, L1
      static_cast<u8>(Risc2::Op::StoreImm), 4, 1,       // si (L1_ptr), 1
      static_cast<u8>(Risc2::Op::Lea), 5, 4, 8,         // lea T0, L1_ptr, 8
      static_cast<u8>(Risc2::Op::StoreImm), 5, 2,       // si (T0), 2
      static_cast<u8>(Risc2::Op::StoreImm), 0, 3,       // si (L0), 3
      static_cast<u8>(Risc2::Op::Lea), 5, 0, 8,         // lea T0, L0, 8
      static_cast<u8>(Risc2::Op::StoreImm), 5, 4,       // si (T0), 4
      // q.c = p.a + p.b + q.a + q.b
      static_cast<u8>(Risc2::Op::Load), 5, 0,           // lw T0, (L0)
      static_cast<u8>(Risc2::Op::Lea), 6, 0, 8,         // lea T1, L0, 8
      static_cast<u8>(Risc2::Op::Load), 7, 6,           // lw T2, (T1)
      static_cast<u8>(Risc2::Op::Add), 6, 5, 7,         // add T1, T0, T2 (p.a+p.b)
      static_cast<u8>(Risc2::Op::Load), 7, 4,           // lw T2, (L1_ptr)
      static_cast<u8>(Risc2::Op::Lea), 8, 4, 8,         // lea T3, L1_ptr, 8
      static_cast<u8>(Risc2::Op::Load), 9, 8,           // lw T4, (T3)
      static_cast<u8>(Risc2::Op::Add), 10, 9, 7,        // add T5, T4, T2
      static_cast<u8>(Risc2::Op::Add), 11, 10, 6,       // add T6, T5, T1
      static_cast<u8>(Risc2::Op::Lea), 6, 4, 16,        // lea T1, T0, 16
      static_cast<u8>(Risc2::Op::Store), 6, 11,         // sw (T1), T6
      // p.c = q.c + p.b
      static_cast<u8>(Risc2::Op::Lea), 5, 4, 16,        // lea T0, L1_ptr, 16
      static_cast<u8>(Risc2::Op::Load), 6, 5,           // lw T1, (T0)
      static_cast<u8>(Risc2::Op::Lea), 5, 0, 8,         // lea T0, L0, 8
      static_cast<u8>(Risc2::Op::Load), 7, 5,           // lw T2, (T0)
      static_cast<u8>(Risc2::Op::Add), 8, 6, 7,         // add T3, T1, T2
      static_cast<u8>(Risc2::Op::Lea), 5, 0, 16,        // lea T0, L0, 8
      static_cast<u8>(Risc2::Op::Store), 5, 8,          // sw (T0), T3
      static_cast<u8>(Risc2::Op::Jump),
  };
  // clang-format on
...
TEST_F(RiscVsCiscTest, DISABLED_Cisc) {
  S param{.a = 0, .b = 1, .c = 0};
